...
static const u8 sFontColorTable[][0] = {
                            // bgColor, textColor, shadowColor
    [COLORID_NORMAL]      = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT,      TEXT_COLOR_TRANSPARENT},
    [COLORID_POCKET_NAME] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT,      TEXT_COLOR_TRANSPARENT},
    [COLORID_GRAY_CURSOR] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT},
    [COLORID_UNUSED]      = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT,        TEXT_COLOR_TRANSPARENT},
    [COLORID_TMHM_INFO]   = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_TRANSPARENT,  TEXT_COLOR_TRANSPARENT}
};
...
static void PrintItemDescription(int itemIndex)
{
    ...
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, str, 3, 1, 0, 0, 0, COLORID_UNUSED);
}
