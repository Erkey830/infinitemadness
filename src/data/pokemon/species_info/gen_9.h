...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_FINIZEN] =
    {
        ...
        .weight = 602,
        .description = COMPOUND_STRING(
            "Su anillo de agua está hecho de agua\nde mar mezclada con un fluido pegajoso\nque Finizen segrega por su espiráculo."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
