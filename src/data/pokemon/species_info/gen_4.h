...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .height = 4,
        .weight = 102,
        .description = COMPOUND_STRING("La concha de su espalda es de tierra\n y se endurece cuando bebe agua. \n Vive cerca de los lagos."),
        .pokemonScale = 491,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .height = 11,
        .weight = 970,
        .description = COMPOUND_STRING("Vive en los bosques cerca del agua.\n Por el día, sale a que les dé el sol\n a las plantas de su espalda."),
        .pokemonScale = 320,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .height = 22,
        .weight = 3100,
        .description = COMPOUND_STRING("Algunos Pokémon nacen en la espalda\n de un Torterra y pasan allí toda\n su vida."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .height = 12,
        .weight = 550,
        .description = COMPOUND_STRING("Utiliza movimientos en combate únicos\n con fuego en manos y pies. Se enfrenta a\n cualquier enemigo."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .height = 4,
        .weight = 52,
        .description = COMPOUND_STRING("Es muy orgulloso, por lo que odia aceptar\n comida de la gente. Su grueso plumón\n le protege del frío."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .height = 8,
        .weight = 230,
        .description = COMPOUND_STRING("Los golpes de sus alas pueden partir\n los árboles más gruesos. Busca\n sus presas en aguas heladas."),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .height = 17,
        .weight = 845,
        .description = COMPOUND_STRING("Los tres cuernos de su pico son muestra\n de su fuerza. El líder es el que tiene\n los cuernos más grandes.\n"),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_STARLY] =
    {
        ...
        .height = 3,
        .weight = 20,
        .description = COMPOUND_STRING("Son débiles individualmente, por eso\n forman grupos. Pero, si el grupo\n crece demasiado, se pelean."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .height = 6,
        .weight = 155,
        .description = COMPOUND_STRING("Son conscientes de su debilidad, así que\n siempre viven en grupo. Si se encuentran\n solos, lloran a gritos.\n"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .height = 12,
        .weight = 249,
        .description = COMPOUND_STRING("Al evolucionar a Staraptor deja su\n bandada y pasa a vivir en soledad.\n Sus alas son inmensas."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .height = 5,
        .weight = 200,
        .description = COMPOUND_STRING("Forman colonias en las riberas de los ríos.\n Cerca de su madriguera se pueden ver rocas\n y troncos roídos."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .height = 10,
        .weight = 315,
        .description = COMPOUND_STRING("Un río en el que un Bibarel cree una\n presa jamás se desbordará. Por\n esa razón la gente los aprecia."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .height = 3,
        .weight = 22,
        .description = COMPOUND_STRING("Tiene las patas cortas. Cada vez que se\n tropieza, sus antenas chocan y suenan\n como un xilófono."),
        .pokemonScale = 530,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .height = 10,
        .weight = 255,
        .description = COMPOUND_STRING("Puede hacer que el sonido resuene en las\n cavidades de su cuerpo y producir un\n hermoso canto."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING("Produce electricidad contrayendo sus\n músculos. Si siente peligro, su\n pelaje brilla resplandeciente."),
        .pokemonScale = 432,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .height = 9,
        .weight = 305,
        .description = COMPOUND_STRING("Para comunicarse, se tocan con las patas\n delanteras y transmiten pulsos eléctricos\n con las garras."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .height = 14,
        .weight = 420,
        .description = COMPOUND_STRING("Cuando sus ojos brillan como el oro,\n puede ver presas escondidas, incluso\n detrás de un muro."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .height = 16,
        .weight = 1025,
        .description = COMPOUND_STRING("Tiene sesos pequeños porque su duro\n cráneo, que soporta cualquier golpe, \n les impide desarrollarse."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .height = 5,
        .weight = 570,
        .description = COMPOUND_STRING("Gracias a su imponente protección facial,\n puede comer hierba y bayas donde quiera\n sin que le molesten."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .height = 13,
        .weight = 1495,
        .description = COMPOUND_STRING("Cuando son atacados, forman una barrera\n con el escudo de sus caras para\n proteger a sus crías."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define WORMADAM_MISC_INFO                                                      \
    ...
    [SPECIES_MOTHIM] =
    {
        ...
        .height = 9,
        .weight = 233,
        .description = COMPOUND_STRING("No tiene nido. Vuela sobre los\n campos y las montañas en busca de\n miel floral."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .height = 11,
        .weight = 335,
        .description = COMPOUND_STRING("Habita en los puertos pesqueros, \n ayudando a rescatar a personas o\n trasladando presas."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define GASTRODON_MISC_INFO                                                             \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .height = 4,
        .weight = 12,
        .description = COMPOUND_STRING("Está formado por los espíritus de\n personas y Pokémon. Le encantan\n las estaciones húmedas."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .height = 12,
        .weight = 150,
        .description = COMPOUND_STRING("Crea en su interior gases y los expulsa.\n De esta forma es capaz de volar y\n controlar su altura."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define LOPUNNY_MISC_INFO                                       \
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .height = 5,
        .weight = 39,
        .description = COMPOUND_STRING("Dependiendo de su humor, mueve\n grácilmente su cola, que se\n asemeja a un lazo de gimnasia\n rítmica."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .height = 10,
        .weight = 438,
        .description = COMPOUND_STRING("Rodea su cuerpo con las colas para\n parecer más grande. Si fija la\n mirada, no se perderá un detalle."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .height = 4,
        .weight = 192,
        .description = COMPOUND_STRING("Expulsa un fluido maloliente por sus\n cuartos traseros. El hedor repele \n Pokémon en un radio de 2 km."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .height = 10,
        .weight = 380,
        .description = COMPOUND_STRING("Ataca emitiendo un fluido maloliente\n por la punta de su cola. Los ataques\n aéreos le confunden."),
        .pokemonScale = 305,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .height = 5,
        .weight = 605,
        .description = COMPOUND_STRING("Se descubrieron herramientas con su\n forma en tumbas antiguas, pero se\n desconoce si tiene relación."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .height = 13,
        .weight = 1870,
        .description = COMPOUND_STRING("Se produjo un gran revuelo cuando\n encontraron uno en una obra después de\n 2000 años durmiendo."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .height = 5,
        .weight = 19,
        .description = COMPOUND_STRING("Mantiene el compás agitando las plumas\n de su cola como un metrónomo.\n Imita el habla humana."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .height = 10,
        .weight = 1080,
        .description = COMPOUND_STRING("Por sus constantes fechorías se le acabó\n uniendo a una Piedra Espíritu con un\n misterioso hechizo."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .height = 7,
        .weight = 205,
        .description = COMPOUND_STRING("Anida en pequeños agujeros en las\n paredes de cuevas. Cuando una presa\n pasa cerca, salta sobre ella."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GABITE] =
    {
        ...
        .height = 14,
        .weight = 560,
        .description = COMPOUND_STRING("Le gustan las cosas brillantes.\n Busca tesoros en cuevas y se\n lleva el botín a su nido."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
...
#define GARCHOMP_MISC_INFO                                      \
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_NONE, ABILITY_ROUGH_SKIN },
        .cryId = CRY_GARCHOMP,
        .description = COMPOUND_STRING("Como sus pequeñas y lisas escamas lo\n hacen muy aerodinámico, puede volar\n a una velocidad increíble."),
...
#define LUCARIO_MISC_INFO                                       \
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .height = 12,
        .weight = 540,
        .description = COMPOUND_STRING("Si se ha entrenado bien, puede\n percibir auras e identificar y asimilar\n sentimientos a 1 km."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .height = 8,
        .weight = 495,
        .description = COMPOUND_STRING("Se embadurna de arena para protegerse\n de los gérmenes. Se desplaza por la\n arena del desierto."),
        .pokemonScale = 366,
        .pokemonOffset = 11,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .height = 20,
        .weight = 3000,
        .description = COMPOUND_STRING("Hace gala de su fuerza abriendo su\n enorme boca. Para atacar levanta gran\n cantidad de arena."),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .height = 8,
        .weight = 120,
        .description = COMPOUND_STRING("Aferra las presas con las garras de la\n cola y les inyecta veneno. Sobrevive un\n año sin comida."),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .height = 13,
        .weight = 615,
        .description = COMPOUND_STRING("Está dentro de una fuerte coraza.\n Su cabeza rota 180 grados para poder\n ver en todas direcciones."),
        .pokemonScale = 272,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .height = 7,
        .weight = 230,
        .description = COMPOUND_STRING("Rara vez combate limpiamente, pero\n es para asegurar su supervivencia.\n Es muy popular como mascota."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .height = 13,
        .weight = 444,
        .description = COMPOUND_STRING("Sus bolsas venenosas almacenan una\n toxina que le llega a las garras por\n unos tubos en los brazos."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .height = 14,
        .weight = 270,
        .description = COMPOUND_STRING("Se cuelga de los árboles en los\n pantanos. Atrae a sus presas con\n su dulce olor y las engulle."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .height = 4,
        .weight = 70,
        .description = COMPOUND_STRING("La línea que le recorre el costado puede\n almacenar luz solar. Brilla con mucha\n fuerza por la noche."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .height = 10,
        .weight = 505,
        .description = COMPOUND_STRING("En primavera, le crecen las bayas con\n apariencia de helado alrededor de\n la panza."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
...
#define ABOMASNOW_MISC_INFO                                 \
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .height = 22,
        .weight = 1355,
        .description = COMPOUND_STRING("Es el abominable hombre de las nieves.\n Produce ventiscas en las montañas\n cubiertas de nieve."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
...
#define ROTOM_APPLIANCE_INFO(form)                                  \
    ...
    [SPECIES_UXIE] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("Dicen que Uxie otorga a la gente la\n sabiduría necesaria para resolver los\n más diversos problemas."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("Voló y los humanos lograron la\n determinación para hacer cosas. Así nació\n la voluntad."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define DIALGA_MISC_INFO                                                                \
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .height = 54,
        .weight = 6830,
        .description = COMPOUND_STRING("Tiene el poder de controlar el tiempo.\n Aparece en los mitos de Sinnoh como una\n vieja deidad."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
...
#define PALKIA_MISC_INFO                                                                \
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .height = 42,
        .weight = 3360,
        .description = COMPOUND_STRING("Tiene la habilidad de distorsionar el\n espacio. La mitología de Sinnoh lo\n describe como una deidad."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .height = 17,
        .weight = 4300,
        .description = COMPOUND_STRING("Su sangre fluye ardiendo como si\n fuera magma. Vive en los cráteres\n de los volcanes"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .height = 37,
        .weight = 4200,
        .description = COMPOUND_STRING("Se dice que usó rocas, magma y un hielo\n especial de montaña para crear Pokémon\n con su aspecto."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 610,
        .trainerOffset = 17,
...
#define GIRATINA_MISC_INFO                                                              \
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .height = 15,
        .weight = 856,
        .description = COMPOUND_STRING("En las noches de media luna, la aurora\n de su cola se extiende y ondea más\n hermosa que nunca."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .height = 4,
        .weight = 31,
        .description = COMPOUND_STRING("Va a la deriva por mares cálidos.\n Siempre vuelve a donde nació, por mucho\n que se haya alejado."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .height = 3,
        .weight = 14,
        .description = COMPOUND_STRING("Nace con un maravilloso poder que le\n permite establecer vínculos con cualquier\n tipo de Pokémon."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .height = 15,
        .weight = 505,
        .description = COMPOUND_STRING("Para protegerse causa pesadillas a\n los que le rodean. Pero no lo \n hace con intención de hacer daño."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
