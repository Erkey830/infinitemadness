...
const u16 gMetatiles_petalburgnds[] = INCBIN_U16("data/tilesets/secondary/petalburgnds/metatiles.bin");
const u16 gMetatileAttributes_petalburgnds[] = INCBIN_U16("data/tilesets/secondary/petalburgnds/metatile_attributes.bin");
