...
{
[NATURE_HARDY] = COMPOUND_STRING("Fuerte"),
[NATURE_LONELY] = COMPOUND_STRING("Solitario"),
[NATURE_BRAVE] = COMPOUND_STRING("Valiente"),
[NATURE_ADAMANT] = COMPOUND_STRING("Afable"),
[NATURE_NAUGHTY] = COMPOUND_STRING("Travieso"),
[NATURE_BOLD] = COMPOUND_STRING("Osado"),
[NATURE_DOCILE] = COMPOUND_STRING("Dócil"),
[NATURE_RELAXED] = COMPOUND_STRING("Relajado"),
[NATURE_IMPISH] = COMPOUND_STRING("Agitado"),
[NATURE_LAX] = COMPOUND_STRING("Flojo"),
[NATURE_TIMID] = COMPOUND_STRING("Tímido"),
[NATURE_HASTY] = COMPOUND_STRING("Activo"),
[NATURE_SERIOUS] = COMPOUND_STRING("Serio"),
[NATURE_JOLLY] = COMPOUND_STRING("Alegre"),
[NATURE_NAIVE] = COMPOUND_STRING("Ingenuo"),
[NATURE_MODEST] = COMPOUND_STRING("Modesto"),
[NATURE_MILD] = COMPOUND_STRING("Amable"),
[NATURE_QUIET] = COMPOUND_STRING("Tranquilo"),
[NATURE_BASHFUL] = COMPOUND_STRING("Tímido"),
[NATURE_RASH] = COMPOUND_STRING("Osado"),
[NATURE_CALM] = COMPOUND_STRING("Calmado"),
[NATURE_GENTLE] = COMPOUND_STRING("Amable"),
[NATURE_SASSY] = COMPOUND_STRING("Pícaro"),
[NATURE_CAREFUL] = COMPOUND_STRING("Cauto"),
[NATURE_QUIRKY] = COMPOUND_STRING("Raro"),
};
